/*Implementare tabela de dispersie - liste înlantuite. Construiti o clasa HashTable (sau HashMap) potrivita ,
care sa includa operatiile de insertie, cautare si stergere. Elementele stocate vor fi de tip (cheie, valoare).
Folositi pair din stl. Rezolvarea coliziunilor se va realiza prin liste înlantuite (folositi std::list).
Daca factorul de încarcare al tabelei depaseste 1.0, se cere redimensionarea tabelei (aproximativ dublul dimensiunii initiale) 
si redistribuirea elementelor în noua tabela (rehashing). În functia main cititi dintr-un fisier n elemente de
tip pereche (cheie-valoare) (n>20), repartizati elementele în tabel , apoi permiteti cautarea, adaugarea sau
stergerea de elemente (meniu). De asemenea permiteti parcurgerea si afisarea perechilor < cheie; valoare >
pentru toate elementele din tabel . (3p).
