// Problema 7
// Se citesc dintr-un fisier un numar de elevi. Fiecare elev are un nume, un prenume si 3 // note, numere naturale. Se va folosi pentru un elev un tuple cu campurile nume si prenume // de tip string si cu trei campuri de note de tip int. Elevii vor fi memorati intr-un 
// obiect de tip std::vector<std::tuple<std::string, std::string, int, int, int> >. Sa se // sorteze vectorul de elevi descrescator dupa medie si sa se afiseze frumos, punand in 
// evidenta elevii cu note mai mici decat 5. (2p)

Exemplu continut fisierElevi.txt
Maria Ionescu 9 8 5
Georgel Marin 3 10 6
David Teodor 4 9 2
Oprea Ioan 5 6 10
...
void citireElevi(std::vector<std::tuple <std::string, std::string, int, int, int>>& elevi)
{
	...
	std::ifstream f("fisierElevi.txt");
